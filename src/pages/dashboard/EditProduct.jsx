...
const EditProduct = () => {
  ...
  const { data = {}, refetch, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data } = await axiosPublic.get(`/product/${params?.id}`);
      return data;
    },
  });
  ...
  useEffect(()=>{
    ...
    mutationFn: async(productData)=>{
       const {data}=await axiosSecure.put(`/product/${params?.id}`,productData)
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-blue-100 animate-slide-in-left hover:shadow-3xl transition-all duration-500">
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  {productData.discount && (
                    <div className="form-group animate-slide-down">
                      ...
                      <input
                        ...
                        min="0"
                        max="100"
                        className="w-full px-4 py-3 border-2 rounded-xl focus:outline-none border-blue-200 hover:border-blue-300"
                ...
                <div className="flex items-center justify-between space-x-4 mt-8">
                  ...
                  <button
                    type="submit"
                    className=" cursor-pointer inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl text-white font-semibold hover:scale-105 transition-transform duration-300 shadow-lg"
                  >
